...
- **Anton vs Fraunces**: Anton handles h1/h2 block letters. Anything inside `.italic-display` (accent words like "engineered", "preventable disease") still uses Fraunces italic. h3 stays Fraunces too. Quotes, prices, partner names · I patched the inline styles in index.astro so they don't accidentally pick up Anton.
